...
import styles from './BoucleHero.module.scss';

const ACTIVE_PADS = new Set([0, 4, 6, 10, 11, 13]);

/**
 * Bespoke Media hero for Boucle — a stylised chroma-key view of its step
 * sequencer (a 16-pad grid, tempo + character dials, transport chrome) instead
 * of the standard poster/carousel. Registered for the 'boucle' slug in registry.
 */
export function BoucleHero({ project }: { project: Project }) {

export const DURATION = { fast: 0.16, base: 0.24, medium: 0.32, reveal: 0.42, bloom: 0.52, hover: 0.26, entrance: 0.5, title: 0.62 } as const;
...
export const EASING = { standard: [0.22, 1, 0.36, 1] as const, out: 'easeOut', inOut: 'easeInOut', linear: 'linear' } as const;

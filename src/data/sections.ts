...
export const SECTIONS: Record<Discipline, Section> = {
  ...
  audio: {
    intro: 'Scores and sound design — the audio under the film work, and a few pieces that stand on their own.',
    cta: { heading: 'Need audio for your screen?', note: 'Compose, design, mix.', subject: 'Project enquiry: Audio' },
  },
  video: {

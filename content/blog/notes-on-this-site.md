...
Colour does the navigating. Each discipline maps to a Radix hue, and the interface re-tints as you move between sections: code, music, sound, photo, video, writing. Cards reveal as they scroll into view, and everything respects a reduced-motion preference if you've set one.
